  ...
  (mapconcat
   (lambda (entry)
     (let* ((fst-level (concat "* " (mw-thesaurus/get-title entry)
            ...
            (syns (mw-thesaurus/other-tag entry 'syn))
            (rels (mw-thesaurus/other-tag entry 'rel))
            (nears (mw-thesaurus/other-tag entry 'near))
            (ants (mw-thesaurus/other-tag entry 'ant)))
